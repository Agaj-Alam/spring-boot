...
VALUES
('Agaj Alam','male','2003-04-06','agajalam@gmail.com','B_POSITIVE'),
('Ravi Kumar','male','1998-11-12','ravikumar@example.com','O_POSITIVE'),
('Priya Sharma','female','2001-02-25','priyasharma@example.com','A_POSITIVE'),
('Amit Singh','male','1995-07-30','amitsingh@example.com','AB_NEGATIVE'),
('Neha Verma','female','2000-05-15','nehaverma@example.com','B_NEGATIVE'),
('Suresh Yadav','male','1989-09-18','sureshyadav@example.com','O_NEGATIVE'),
('Anjali Gupta','female','1997-03-11','anjaligupta@example.com','A_NEGATIVE'),
